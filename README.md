...
Designed Enterprise-Grade Visualizations: Programmed multi-axis trendlines, interactive choropleth maps, and OLS regression scatter plots (Vaccination vs. Mortality Rates) to derive and present actionable public health insights.
Cloud Production Deployment: Containerized and deployed the backend Python server to a live cloud environment via Render.com using Gunicorn WSGI, ensuring public accessibility for portfolio demonstration.
